...
<Callout title="Update">
  A new blog post has been written about this topic! Check out [How to use
  1Password for Secrets in ~/.bashrc or ~/.zshrc
  (UPDATE)](/blog/2023-11-28-1password-for-secret-dotfiles-update).
</Callout>
