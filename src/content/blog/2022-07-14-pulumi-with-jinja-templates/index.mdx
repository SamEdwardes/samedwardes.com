...
<LocalCodeChunk lang="bash" src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/_example-project/requirements.txt"/>
...
<Collapse title="Expand to see create_keypair.py">
    <LocalCodeChunk lang="bash" src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/_example-project/create_keypair.py"/>
</Collapse>
...
<Collapse title="Expand to see __main__.py">
    <LocalCodeChunk lang="bash" src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/_example-project/__main__.py"/>
</Collapse>
...
<LocalCodeChunk lang="bash" src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/_example-project/templates/template.env" />
...
<LocalCodeChunk lang="bash" src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/_example-project/.envout" />
