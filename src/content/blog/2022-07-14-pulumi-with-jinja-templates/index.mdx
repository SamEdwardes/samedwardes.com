...
Lets see what is inside the _requirements.txt_:

<LocalCodeChunk
  lang="bash"
  src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/requirements.txt"
/>
...
<Collapse title="Expand to see create_keypair.py">
  <LocalCodeChunk
    lang="bash"
    src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/create_keypair.py"
  />
</Collapse>

Lastly, create a new pulumi stack. I will name my stack _dev_, but you can call it whatever you like.
...
<Collapse title="Expand to see __main__.py">
  <LocalCodeChunk
    lang="bash"
    src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/__main__.py"
  />
</Collapse>
...
<LocalCodeChunk
  lang="bash"
  src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/templates/template.env"
/>
...
<LocalCodeChunk
  lang="bash"
  src="/blog-assets/2022-07-14-pulumi-with-jinja-templates/.envout"
/>
