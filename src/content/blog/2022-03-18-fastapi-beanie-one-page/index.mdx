...
<Callout title="Warning">Sorry, under development 🤷‍♂️</Callout>
...
Below are the instructions on how to install MongoDB for each operating system. You probably want to install the _Community Edition_.
...
<Callout title="Note">
  Check out the official MongoDB docs here:
...
<Collapse title="main.py: This is where all of our python code lives.">
  <LocalCodeChunk
    src="/blog-assets/2022-03-18-fastapi-beanie-one-page/main.py"
    lang="python"
  />
</Collapse>
...
<Collapse title="templates/_layout.html: This template is the base template which all others will inherit from. It contains common elements such as the navigation bar and footer. This tutorial will not dive deep into Jinja2 templates, so just take a quick look at this code and then copy it into your project.">
  <LocalCodeChunk
    src="/blog-assets/2022-03-18-fastapi-beanie-one-page/templates/_layout.html"
    lang="html"
  />
</Collapse>
...
<Collapse title="templates/index.html: The template for the home page.">
  ...
  <LocalCodeChunk
    src="/blog-assets/2022-03-18-fastapi-beanie-one-page/templates/index.html"
    lang="html"
  />
</Collapse>
...
<Collapse title="templates/dogs.html: The templates for the dogs page.">
  ...
  <LocalCodeChunk
    src="/blog-assets/2022-03-18-fastapi-beanie-one-page/templates/dogs.html"
    lang="html"
  />
</Collapse>
...
<Collapse title="templates/dog_profile.html: The templates for the dog profile page.">
  ...
  <LocalCodeChunk
    src="/blog-assets/2022-03-18-fastapi-beanie-one-page/templates/dog_profile.html"
    lang="html"
  />
</Collapse>
...
<Callout title="Note">
  The function is async. This is because beanie only supports async interactions
  with MongoDB. Therefore, whenever we are interacting with the database it must
  be async. This could change in the future, but as of March 2022 beanie is ONLY
  async.
</Callout>
...
<Callout title="Note">
  In a "real" production app you would probably not have any logic here to check
  if the database has been created already. We put the logic in this app simply
  because it is a demo app.
</Callout>
...
<Callout title="Tip">
  The order does not matter. FastAPI knows that `dog_id` is a path parameter
  because we also have a `{dog_id}` in our URL path. See
  https://fastapi.tiangolo.com/tutorial/path-params/ for more info.
</Callout>
