...
Once the transfer is complete, unplug your watch. Wait a few seconds. Your watch should indicate that it is loading new maps. To use the map, navigate to _Settings_ > _Activities & Apps_ > _Hike_ > _Hike Settings_ > _Map_ > _Configure Map_. Then select your new map. You know it is selected when the little sidebar is green. You should repeat the last step for each activity you want to use with your new map. My new map had a confusing name like this:
